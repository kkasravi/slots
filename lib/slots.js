(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    var ConstsType = (function() {
      ...
      ConstsType.columnWidth = 220;
      ConstsType.columnHeight = 220;
      return function __() {
        var args = Array.prototype.slice.call(arguments);
    ...
    var Container = (function() {
      ...
      Container.init = (function () {
        var styles=[{
          selector:'.container',
          style:"margin:25% 10px;-webkit-perspective:5000px;-webkit-perspective-origin:50% 0px;-moz-perspective:2000px;-moz-perspective-origin: 50% 0px;"
        },{
          selector:'.stage',
